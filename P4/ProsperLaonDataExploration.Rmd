...
As you can notice from below provided summary, majority of loans are non classified, and among the classified ones 'C' is the majority rating.
```{r echo=FALSE}
...
ggplot(aes(y = LoanOriginalAmount, x = Term), data = ProsperLoanData) +
